...
use Mimmi20\Mezzio\BootstrapForm\LaminasView\View\Helper\FormSubmitFactory;
...
final class FormSubmitFactoryTest extends TestCase
{
    private FormSubmitFactory $factory;

    /** @throws void */
    protected function setUp(): void
    {
        $this->factory = new FormSubmitFactory();
    }
    ...
    public function testInvocation(): void
    {
        ...
        self::assertInstanceOf(FormSubmit::class, $helper);
    }
