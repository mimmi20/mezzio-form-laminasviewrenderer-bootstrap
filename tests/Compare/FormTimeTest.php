...
final class FormTimeTest extends AbstractTestCase
{
    /**
     * @throws Exception
    ...
    {
        $form = (new Factory())->createForm(require '_files/config/time.config.php');

        $expected = $this->getExpected('form/time.html');
        ...
        self::assertSame($expected, trim($helper->render($form->get('inputTime'))));
    }
}
