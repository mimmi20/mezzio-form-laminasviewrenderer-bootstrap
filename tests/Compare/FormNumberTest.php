...
final class FormNumberTest extends AbstractTest
{
    /**
    ...
    {
        $form = (new Factory())->createForm(require '_files/config/number.config.php');

        $expected = $this->getExpected('form/number.html');
        ...
        self::assertSame($expected, trim($helper->render($form->get('inputNumber'))));
    }
}
