...
final class FormEmailTest extends AbstractTestCase
{
    /**
     * @throws Exception
    ...
    {
        $form = (new Factory())->createForm(require '_files/config/email.config.php');

        $expected = $this->getExpected('form/email.html');
        ...
        self::assertSame($expected, trim($helper->render($form->get('inputEmail'))));
    }
}
