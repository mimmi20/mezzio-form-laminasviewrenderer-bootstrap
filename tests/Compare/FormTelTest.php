...
use Mimmi20\Mezzio\BootstrapForm\LaminasView\View\Helper\FormTel;
...
final class FormTelTest extends AbstractTestCase
{
    /**
     *
     * @throws Exception
    ...
    {
        $form = (new Factory())->createForm(require '_files/config/tel.config.php');

        $expected = $this->getExpected('form/tel.html');
        ...
        self::assertSame($expected, trim($helper->render($form->get('inputTel'))));
    }
}
