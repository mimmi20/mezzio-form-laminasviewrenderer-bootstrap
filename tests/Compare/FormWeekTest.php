...
final class FormWeekTest extends AbstractTestCase
{
    /**
     * @throws Exception
    ...
    {
        $form = (new Factory())->createForm(require '_files/config/week.config.php');

        $expected = $this->getExpected('form/week.html');
        ...
        self::assertSame($expected, trim($helper->render($form->get('inputWeek'))));
    }
}
