...
use Mezzio\BootstrapForm\LaminasView\View\Helper\FormSearch;
...
final class FormSearchTest extends TestCase
{
    ...
    public function testRenderHtml(): void
    {
        ...
        $expected = sprintf('<input class="form-control&#x20;%s" name="%s" type="search" value="%s">', $class, $name, $value);
    ...
    public function testRenderReadonlyXHtml(): void
    {
        ...
        $expected = sprintf('<input class="form-control-plaintext" readonly="readonly" name="%s" type="search" value="%s"/>', $name, $value);
