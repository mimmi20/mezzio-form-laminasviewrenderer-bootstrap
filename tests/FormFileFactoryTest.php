...
use Mimmi20\Mezzio\BootstrapForm\LaminasView\View\Helper\FormFileFactory;
...
final class FormFileFactoryTest extends TestCase
{
    private FormFileFactory $factory;

    /** @throws void */
    protected function setUp(): void
    {
        $this->factory = new FormFileFactory();
    }
    ...
    public function testInvocation(): void
    {
        ...
        self::assertInstanceOf(FormFile::class, $helper);
    }
