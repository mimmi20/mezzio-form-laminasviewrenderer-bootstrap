...
final class FormResetTest extends TestCase
{
    ...
    public function testRenderHtml(): void
    {
        ...
        $expected = sprintf('<input class="form-control&#x20;%s" name="%s" type="reset" value="%s">', $class, $name, $value);
    ...
    public function testRenderReadonlyXHtml(): void
    {
        ...
        $expected = sprintf('<input class="form-control-plaintext" name="%s" type="reset" value="%s"/>', $name, $value);
