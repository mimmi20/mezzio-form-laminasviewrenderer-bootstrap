...
final class FormTextTest extends TestCase
{
    /**
     * @throws Exception
    ...
    public function testRenderHtml(): void
    {
        ...
        $expected = sprintf('<input class="form-control&#x20;%s" name="%s" type="text" value="%s">', $class, $name, $value);
    ...
    public function testRenderReadonlyXHtml(): void
    {
        ...
        $expected = sprintf('<input class="form-control-plaintext" readonly="readonly" name="%s" type="text" value="%s"/>', $name, $value);
