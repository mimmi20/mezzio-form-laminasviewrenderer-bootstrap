...
final class FormPasswordFactory
{
    /**
     * @throws ContainerExceptionInterface
     */
    public function __invoke(ContainerInterface $container): FormPassword
    {
        ...
        return new FormPassword($escapeHtml, $escapeHtmlAttr, $docType);
    }
}
