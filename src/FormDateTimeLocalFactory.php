...
final class FormDateTimeLocalFactory
{
    /**
     * @throws ContainerExceptionInterface
     */
    public function __invoke(ContainerInterface $container): FormDateTimeLocal
    {
        ...
        return new FormDateTimeLocal($escapeHtml, $escapeHtmlAttr, $docType);
    }
}
